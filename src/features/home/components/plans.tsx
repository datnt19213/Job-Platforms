			...
			<div className="w-full py-16">
				<div className="container mx-auto px-4">
					...
					<div className="text-center mb-12">
						<h2 className="text-[24px] md:text-[30px] font-bold text-blue-dark mb-4">
                ...
                return (
                  <ScrollAnimator key={index} delay={index * 0.1} isZoom={false} fade slide="down" distancing={20} className='w-fit'>
                  <Card
  									key={index}
  									className={`relative bg-white shadow-none border transition-all duration-200 hover:shadow-light group hover:bg-[#F5F7FB] ${
                      plan.highlighted ? "border-blue-dark bg-[#F5F7FB] shadow-md" : "border-gray-200"
  									}`}
  								>
  										...
  										<div className="mb-6">
  											<h3
  												className={`text-[22px] font-bold ${
  													plan.highlighted ? "text-blue-dark" : "text-gray-900"
  												}`}
  											>
  												{plan.name}
  											</h3>
  											<div
  												className={`text-[40px] font-extrabold mb-[30px] ${
  													plan.highlighted ? "text-[#3642AD]" : "text-gray-900"
  												}`}
  											>
  												{plan.price}
  											</div>
  											<div className="w-16 h-16 mx-auto mb-4 bg-purple-100 rounded-lg flex items-center justify-center">
  												<Image src={plan.icon} alt="icon" className="min-w-[90px] h-[90px]" />
  											</div>
  										</div>
  									</CardHeader>
