...
const RightMiniDetail = () => {
	return (
		<FlexLayout direction="col" justify="start" className="px-[15px] hidden min-[990px]:flex">
			<StickyBox>
				<FlexLayout
					direction="col"
					justify="start"
					className="p-[15px] border border-gray-200 bg-white rounded-[8px] xl:rounded-[18px] min-[990px]:p-[30px] w-full"
				>
					<FlexLayout
						direction="col"
						justify="start"
						className="bg-[#F5F7FC] rounded-[18px] p-[15px] min-[990px]:p-[30]"
					>
